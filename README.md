...
Для новой установки и обновления используйте [текущий выпуск v1.0.3](docs/releases/v1.0.3.md). При переходе с `v1.0.0` или `v1.0.1` дополнительно обновите выделенное Python-окружение и удалите из него ChromaDB по [миграционной инструкции выпуска v1.0.2](docs/releases/v1.0.2.md#обновление-с-v100-и-v101).
...
Последний полный локальный прогон перед публичной упаковкой: **622 проверки** — 304 JavaScript, 288 Python и 30 E2E.
