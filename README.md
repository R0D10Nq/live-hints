...
При обновлении с `v1.0.0` или `v1.0.1` обязательно используйте выпуск `v1.0.2`, обновите выделенное Python-окружение и удалите из него ChromaDB по [инструкции выпуска v1.0.2](docs/releases/v1.0.2.md#обновление-с-v100-и-v101).
...
Последний полный локальный прогон перед публичной упаковкой: **621 проверка** — 304 JavaScript, 287 Python и 30 E2E.
