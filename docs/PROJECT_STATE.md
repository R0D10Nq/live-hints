...
- **Последнее обновление**: Обновлён pyaudiowpatch и подготовлен выпуск 1.0.3
...
| -------------------- | -------- | --------------------- |
| Модульные Python     | Работает | 288 тестов            |
...
- Обновлён `aiohttp` до исправленной версии 3.14.3
- Обновлён `pyaudiowpatch` до 0.2.12.8 и подтверждён захват через WASAPI
- Подготовлены установщик и portable-сборка 1.0.3
