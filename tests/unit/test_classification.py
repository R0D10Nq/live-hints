...
def test_get_max_tokens_for_type():
    ...
    assert get_max_tokens_for_type('experience') == 160
    assert get_max_tokens_for_type('technical') == 140
    assert get_max_tokens_for_type('general') == 100
    assert get_max_tokens_for_type('unknown') == 130  # fallback
...
def test_get_temperature_for_type():
    ...
    assert get_temperature_for_type('experience') == 0.7
    assert get_temperature_for_type('technical') == 0.4
    assert get_temperature_for_type('general') == 0.6
    assert get_temperature_for_type('unknown') == 0.6  # fallback
