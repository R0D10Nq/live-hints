...
class OnboardingApp {
    ...
    bindEvents() {
        this.elements.btnMinimize?.addEventListener('click', () => window.electronAPI?.minimizeWindow());
        ...
        this.elements.btnRequestMic?.addEventListener('click', () => this.audioSetup.requestMicrophoneAccess());
    ...
    updateUI() {
        ...
        if (this.currentStep === 2) {
            ...
            if (this.elements.btnNext) this.elements.btnNext.disabled = !hasResume;
